...
namespace Shapes
{
    class Shapes
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Фигура с наибольшей площадью: {0}", figures[0]);

            Array.Sort(figures, new PerimetersComparer());
            Console.WriteLine("Фигура со вторым по величине периметром: {0}", figures[1]);
            ...
            foreach (IShape figure1 in figures)
            {
                ...
                {
                    Console.WriteLine("Сравниваем {0} и {1}, результат {2}", figure1, figure2, figure1 == figure2);
                }
            }
